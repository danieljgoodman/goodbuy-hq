...
describe('ShadcnShowcase Component', () => {
  describe('Basic Rendering', () => {
    it('renders the main heading', () => {
      ...
      expect(screen.getByText('Modern, accessible React components with proper TypeScript support')).toBeInTheDocument()
    })
  ...
  describe('Users Tab', () => {
    it('displays users tab content by default', () => {
      ...
      expect(screen.getByText('Search and filter through your team members')).toBeInTheDocument()
    })
  ...
  describe('Analytics Tab', () => {
    ...
    it('displays progress bar', async () => {
      ...
      await waitFor(() => {
        ...
        expect(screen.getByText('Current sprint completion status')).toBeInTheDocument()
  ...
  describe('Accessibility', () => {
    it('has proper heading hierarchy', () => {
      ...
      const mainHeading = screen.getByRole('heading', { level: 1, name: 'ShadCN UI Showcase' })
  ...
  describe('Responsive Design', () => {
    ...
    it('handles responsive classes', () => {
      ...
      const mainContainer = screen.getByText('ShadCN UI Showcase').closest('div')
