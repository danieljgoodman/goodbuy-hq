...
describe('BusinessEvaluationForm Integration Tests', () => {
  ...
  describe('Form Validation', () => {
    ...
    it('validates business details step', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(/annual revenue is required/i)
        ).toBeInTheDocument()
        expect(
          screen.getByText(/number of employees is required/i)
        ).toBeInTheDocument()
      })
    })
    ...
    it('validates financial data step', async () => {
      ...
      await waitFor(() => {
        ...
        expect(
          screen.getByText(/assets value is required/i)
        ).toBeInTheDocument()
      })
    })
    ...
    it('validates numeric fields with proper ranges', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(/revenue must be a positive number/i)
        ).toBeInTheDocument()
      })
    })
  })
  ...
  describe('Form Calculation', () => {
    ...
    it('shows loading state during calculation', async () => {
      const user = userEvent.setup()
      mockCalculateValuation.mockImplementation(
  ...
  describe('Advanced Features', () => {
    ...
    it('provides field help tooltips', async () => {
      ...
      const helpIcon = screen.getByRole('button', {
        name: /help for annual revenue/i,
      })
      await user.hover(helpIcon)

      await waitFor(() => {
        expect(
          screen.getByText(/total income generated by your business/i)
        ).toBeInTheDocument()
      })
    })
  })
  ...
  describe('Data Export and Import', () => {
    ...
    it('imports form data from file', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByDisplayValue('Imported Business')
        ).toBeInTheDocument()
      })
    })
  })
