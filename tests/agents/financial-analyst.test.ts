import FinancialAnalyst, { FinancialStatement } from '@/agents/financial-analyst';
...
describe('FinancialAnalyst', () => {
  ...
  describe('importBusinessData', () => {
    ...
    it('should handle missing revenue data', () => {
      const dataWithoutRevenue = { ...mockBusinessData, annualRevenue: undefined };
  ...
  describe('calculateFinancialRatios', () => {
    ...
    it('should handle zero denominators safely', () => {
      const zeroRevenueData = { ...mockBusinessData, annualRevenue: 0, monthlyProfit: 0 };
  ...
  describe('calculateFinancialHealthScore', () => {
    ...
    it('should provide recommendations and insights', () => {
      ...
      expect(['Low', 'Medium', 'High', 'Critical']).toContain(healthScore.riskLevel);
    });
  });
  ...
  describe('analyzeCashFlow', () => {
    it('should analyze cash flow metrics', () => {
      ...
      expect(['Stable', 'Variable', 'Volatile']).toContain(cashFlowAnalysis.cashFlowPredictability);
    });
  });
  ...
  describe('analyzeTrends', () => {
    ...
    it('should analyze trends when sufficient data exists', () => {
      ...
      const updatedData = { ...mockBusinessData, annualRevenue: 1200000, monthlyProfit: 55000 };
