...
export async function POST(request: NextRequest) {
  try {
    ...
    const fullAnalysis = await businessAnalysisAgent.analyzeBusinessComprehensively(businessData);
    ...
    switch (insightType) {
      ...
      case 'valuation-estimate':
        ...
        const estimatedValue = Math.max(revenue * revenueMultiple, netWorth * 0.8);
        ...
        focusedInsight = {
          ...
          data: {
            ...
            revenueMultiple,
            confidence: fullAnalysis.financialHealth.score > 70 ? 'high' : 
                       fullAnalysis.financialHealth.score > 40 ? 'medium' : 'low',
            factors: [
