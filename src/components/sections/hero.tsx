          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="space-y-4">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-secondary-900 leading-tight">
                Get Your Business
                <span className="text-primary-600 block">Valued by AI</span>
                in Minutes
              </h1>
              <p className="text-lg sm:text-xl text-secondary-600 leading-relaxed max-w-2xl">
                Our advanced AI analyzes your financials, market position, and
                growth potential to provide accurate business valuations trusted
                by thousands of entrepreneurs and investors.
              </p>
            </div>
